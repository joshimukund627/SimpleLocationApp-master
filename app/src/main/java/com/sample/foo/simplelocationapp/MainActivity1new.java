...
public class MainActivity1new extends Activity
{
            	...
            	if (location != null)
                {
                	...
                	{ 
                        public void run() 
                        {
                        	...
                        	Toast.makeText(MainActivity1new.this, "My location code update", Toast.LENGTH_SHORT).show();
                        }
                    }));
                }
               else
                ...
                if (location != null) 
                {
                	...
                	{ 
                        public void run() 
                        {
                        	...
                        	Toast.makeText(MainActivity1new.this, "Fused location code update", Toast.LENGTH_SHORT).show();
                        }
                    }));
